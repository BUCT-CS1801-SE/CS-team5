  ...
  <el-card class="box-card">
    ...
    <div>
      ...
      >
        ...
        <el-table-column sortable fixed prop="name" label="藏品名" width="150">
        </el-table-column>
        <el-table-column sortable prop="intro" label="介绍" width="150">
        </el-table-column>
        <el-table-column sortable prop="mu_id" label="博物馆号" width="150">
        </el-table-column>
        <el-table-column sortable prop="age" label="年代" width="150">
        </el-table-column>
        <el-table-column sortable prop="image" label="图片链接" width="150">
        </el-table-column>
...
export default {
  ...
  created() {
    this.$axios.get("/api/getcollection").then((response) => {
